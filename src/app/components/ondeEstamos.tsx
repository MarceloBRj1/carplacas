...
const AreWe = () => {
  return (
    ...
    className='bg-blue-900 h-[1280px] md:h-[650px] lg:h-[700px] container mx-auto rounded-lg'>
      ...
      <div className='text-center text-white font-semibold flex flex-col'>
        <h1 className='text-orange-400 font-mono text-xl'>Filial: Loja Maraponga</h1>
        <p className='font-sans' >Av. Godofredo Maciel, 2113 - Maraponga, Fortaleza - CE, 60710-001</p>
        <iframe className='mt-3 self-center w-screen sm:w-96' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d591.7898973195298!2d-38.56911369783913!3d-3.794481897303203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7c749359a84016d%3A0x8cbab10c1eb38a9c!2sSH%20Emplacamentos%20-%20Despachante%20Detran%2C%20licenciamento%2C%20IPVA%2C%20Multas%20em%20Fortaleza!5e0!3m2!1spt-BR!2sbr!4v1709040282593!5m2!1spt-BR!2sbr" width="500" height="350"></iframe>
        <div className='mt-7 flex items-center self-center'>
          <h1 className='mr-4 hover:text-orange-400 font-sans'>Ir com Waze</h1>
          <motion.button
          whileHover={{ scale: 1.1 }}
