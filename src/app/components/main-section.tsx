...
const MainSection = () => {
  return (
    <section className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 border-transparent">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        <motion.div
          ...
          className="relative overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full"
        >
          <Image
            src='/equipecar.jpeg'
            width={1000}
